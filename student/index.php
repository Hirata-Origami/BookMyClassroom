                            ...
                            <div class="row">
                                <div class="col-lg-12 inputBx">
                                    <div class="form-group">
                                        <label class="" for="uname">Email</label>
                                ...
                                <div class="col-lg-12 inputBx">
                                    <div class="form-group">
                                        <label class="" for="">Demo Account :- <br>Email : 22pw01@psgtech.ac.in <br>Password : 22pw</label>
                                    </div>
                                </div>
                                

                                <div class="col-lg-12 text-center inputBx">
