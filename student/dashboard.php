                ...
                <div class="card-group">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-light mb-1 font-weight-medium"><?php include 'counters/student-count.php'?></h2>
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-light mb-1 w-100 text-truncate font-weight-medium"><?php include 'counters/room-count.php'?></h2>
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-light mb-1 font-weight-medium"><?php include 'counters/booked-count.php'?></h2>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-light mb-1 font-weight-medium"><?php include 'counters/course-count.php'?></h2>
