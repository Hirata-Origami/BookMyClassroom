<?php
    ...
    $rc=$stmt->bind_param('ssssisi',$fname,$mname,$lname,$gender,$contactno,$aid);
    $stmt->execute();
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-light font-weight-medium mb-1">My Profile</h4>
                </div>
                ...
                <div class="row">
                    ...
                    $aid=$_SESSION['id'];
                        ...
                        <!--<div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-light">Last Updated On</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-light">Email Address</h4>
                                        <div class="form-group">
