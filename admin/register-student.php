        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-light font-weight-medium mb-1">Student Registration Form</h4>
                ...
                <form method="POST" name="registration" onSubmit="return valid();">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-light">Email ID</h4>
                                        <div class="form-group">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-light">Password</h4>
                                        <div class="form-group">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-light">Confirm Password</h4>
                                        <div class="form-group">
