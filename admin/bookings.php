<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query="INSERT into  registration(roomno,stayfrom,duration,course,regno,firstName,middleName,lastName,gender,contactno,emailid) values(?,?,?,?,?,?,?,?,?,?,?)";
        $stmt = $mysqli->prepare($query);
        $rc=$stmt->bind_param('ssissssssis',$roomno,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid);
        $stmt->execute();
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-light font-weight-medium mb-1">Hostel Bookings</h4>
            ...
            <form method="POST">
                ...
                <?php
                    ...
                    <div class="alert alert-primary alert-dismissible bg-primary text-white border-0 fade show"
                        ...
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                ...
                                <strong class="bg-transparent">Info: </strong> You have already booked a hostel!
                    </div>
                    <?php }
                    else{
						echo "";
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Room Number</h4>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Date</h4>
                                    <div class="form-group mb-4">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Period</h4>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Duration</h4>
                                    <div class="form-group mb-4">
                                        <select class="custom-select mr-sm-2" id="duration" name="duration">
                                            <option selected>Choose...</option>
                    ...
                    <!--<div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                        <div class="card-body">
                                <h4 class="card-title text-light">Food Status</h4>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Total Fees Per Month</h4>
                                    <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Total Amount</h4>
                                    <div class="form-group">
                ...
                <h4 class="card-title text-light mt-5">Student's Personal Information</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-light">Registration Number</h4>
                                        <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">First Name</h4>
                                    <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Middle Name</h4>
                                    <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Last Name</h4>
                                    <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Email</h4>
                                    <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Gender</h4>
                                    <div class="form-group mb-4">
                                    <select name="gender" class="form-control custom-select mr-sm-2" required="required">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Contact Number</h4>
                                    <div class="form-group">
                    ...
                    <!--<div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Emergency Contact Number</h4>
                                    <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-light">Course</h4>
                                    <div class="form-group mb-4">
                ...
                <!--<h4 class="card-title text-light mt-5">Guardian's Information</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-light">Guardian Name</h4>
                                        <div class="form-group">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-light">Relation</h4>
                                        <div class="form-group">
                    ...
                    <h4 class="card-title text-light mt-5">Current Address Information</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-light">Address</h4>
                                        <div class="form-group">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-light">City</h4>
                                        <div class="form-group">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-light">Postal Code</h4>
                                        <div class="form-group">
                    ...
                    <!--<h4 class="card-title text-light mt-5">Permanent Address Information</h4>
                    ...
                    <h5 class="card-title text-light mt-5">Please fill up the form "ONLY IF" you've different permanent address!</h5>
